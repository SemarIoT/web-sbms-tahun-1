                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a class="btn btn-success btn-sm"
                                                href="validate_doorlockAccess/{{$doorlockaccessvalidates->id}}">Setujui</a>
                                            <a class="btn btn-danger btn-sm"
                                                href="reject_doorlockAccess/{{$doorlockaccessvalidates->id}}">Tolak</a>
                                        </td>
                                    </tr>
                                    @endforeach
                                </table>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            ...
                                            <a class="btn btn-primary btn-sm"
                                                href="edit_doorlockAccess/{{$doorlockaccesses->id}}">Edit</a>
                                            <a href="delete_doorlockAccess/{{$doorlockaccesses->id}}"
