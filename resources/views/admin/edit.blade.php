                        ...
                        <form class="form-horizontal" id="formEditUser" name="formEditUser" method="POST"
                            ...
                            <div class="form-group mb-3">
                                ...
                                <div class="col-center">
                                    <input type="text" id="name-edit" name="name-edit" value="{{$eu->name}}"
                                        class="form-control">
                                </div>
                            </div>
                            <div class="form-group mb-3">
                                ...
                                <div class="col-center">
                                    <input type="text" id="username-edit" name="username-edit" value="{{$eu->username}}"
                                        class="form-control">
                                </div>
                            </div>
                            <div class="form-group mb-3">
                                ...
                                <div class="col-center">
                                    <select id="level-edit" name="level-edit"
                                        class="btn btn-outline-secondary dropdown-toggle" value="{{$eu->level}}"
                                        type="button" data-bs-toggle="dropdown" aria-expanded="false"
                                        form="formEditUser">Level
                            ...
                            <div class="form-group mb-3">
                                ...
                                <div class="col-center">
                                    <input type="email" id="email-edit" name="email-edit" value="{{$eu->email}}"
                                        class="form-control">
                                </div>
                            </div>
                            <div class="form-group mb-3">
