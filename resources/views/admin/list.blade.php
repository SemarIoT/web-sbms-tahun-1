                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            ...
                                            <a class="btn btn-primary btn-sm"
                                                href="daftar-admin-edit/{{$dev->id}}">Edit</a>
                                            <a href="deleteUser/{{$dev->id}}"
                                ...
                                <table class="table table-bordered">
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            ...
                                            <a class="btn btn-primary btn-sm"
                                                href="daftar-admin-edit/{{$admins->id}}">Edit</a>
                                            <a href="deleteUser/{{$admins->id}}"
                                                onclick="return confirm('Apakah Anda Yakin Menghapus Data?');"
                                                class="btn btn-danger btn-sm">Delete</a>
                                ...
                                <table class="table table-bordered">
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            ...
                                            <a class="btn btn-primary btn-sm"
                                                href="daftar-admin-edit/{{$userr->id}}">Edit</a>
                                            <a href="deleteUser/{{$userr->id}}"
                                                onclick="return confirm('Apakah Anda Yakin Menghapus Data?');"
                                                class="btn btn-danger btn-sm">Delete</a>
