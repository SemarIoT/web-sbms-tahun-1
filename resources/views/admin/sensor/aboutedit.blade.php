                        ...
                        <form class="form-horizontal" id="formEditUser" name="formEditUser" method="POST"
                            ...
                            <div class="form-group mb-3">
                                ...
                                <div class="col-center">
                                    ...
                                    <input type="text" id="link-edit" name="link-edit" value="{{$editcameras->link}}"
                                        class="form-control">

                                </div>
                            </div>
                            @else
                            <input type="hidden" id="link-edit" name="link-edit" value="{{$editcameras->link}}"
                                class="form-control">
                            @endif
                            <div class="form-group mb-3">
                                <label for="name-edit" class="col-dm-6 control-label">Deskripsi</label>
                                <div class="col-center">
                                    <input type="text" id="deskripsi-edit" name="deskripsi-edit"
                                        value="{{$editcameras->deskripsi}}" class="form-control">
                                </div>
                            </div>
