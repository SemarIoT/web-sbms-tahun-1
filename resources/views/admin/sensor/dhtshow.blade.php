                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="row d-flex justify-content-center pt-0">
                                    <div class="col-lg-12">
                                        <p class="text-xl fw-light mb-0 text-center text-info">{{$abouts->link}}/api/Dht
                                        </p><span>

                                            <p class="text text-start fw-light mb-0 ">Cara Penggunaan:</p><span>
                                                <p class="text text-start mb-0 ">method -> POST</p><span>
                                                    <p class="text text-start mb-0 ">field -> temperature, humidity</p>
                                                    <span>
                                                        <p class="text text-start mb-0 text-primary ">contoh ->
                                                            /api/Dht?temperature=25&humidity=50</p><span>
                                    </div>
