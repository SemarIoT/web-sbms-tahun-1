                ...
                <div class="card">
                    ...
                    <div class="card-body pt-0">
                        ...
                        <form class="form-horizontal" id="formEditUser" name="formEditUser" method="POST"
                            action="{{ url('settingupdatehargaenergyadmin') }}">
                            {{ csrf_field() }}
                            <input type="hidden" name="id" value="{{$edithargas->id}}">
                            <div class="form-group mb-3">
                                <label for="name-edit" class="col-dm-6 control-label">Harga</label>
                                <div class="col-center">
                                    <input type="text" id="harga-edit" name="harga-edit" value="{{$edithargas->pokok}}"
                                        class="form-control">
                                </div>
                            </div>
                            @if (Auth::user()->level == 'Admin')
                            <input type="hidden" id="delay-edit" name="delay-edit" value="{{$edithargas->delay}}"
                                class="form-control">
                            @endif
                            ...
                            <div class="form-group mb-3">
                                ...
                                <div class="col-center">
                                    <input type="text" id="delay-edit" name="delay-edit" value="{{$edithargas->delay}}"
                                        class="form-control">
                                </div>
                            </div>
                            @endif
