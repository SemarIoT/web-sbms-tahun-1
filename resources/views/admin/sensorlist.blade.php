                            ...
                            <div class="card-body">
                                ...
                                <table class="table table-bordered">
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a class="btn btn-info btn-sm"
                                                href="showPanelMasterList/{{$energy_panel_masters->id}}">API</a>
                                            @if (Auth::user()->level == 'Developer')
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a class="btn btn-info btn-sm"
                                                href="showOutletMasterList/{{$energy_outlet_masters->id}}">API</a>
                                            @if (Auth::user()->level == 'Developer')
                                            {{-- <a class="btn btn-primary btn-sm" href="#">Edit</a>
                                            <a href="#" class="btn btn-danger btn-sm">Delete</a> --}}
                                            @endif
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a class="btn btn-info btn-sm"
                                                href="showPanelList/{{$energy_panels->id}}">API</a>
                                            @if (Auth::user()->level == 'Developer')
                                            <a class="btn btn-primary btn-sm"
                                                href="daftar-Panel-edit/{{$energy_panels->id}}">Edit</a>
                                            <a href="deletePanelList/{{$energy_panels->id}}"
                            ...
                            <div class="card-body">
                                ...
                                <table class="table table-bordered">
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a class="btn btn-info btn-sm"
                                                href="showOutletList/{{$energy_outlets->id}}">API</a>
                                            @if (Auth::user()->level == 'Developer')
                                            <a class="btn btn-primary btn-sm"
                                                href="daftar-Outlet-edit/{{$energy_outlets->id}}">Edit</a>
                                            <a href="deleteOutletList/{{$energy_outlets->id}}"
                                                onclick="return confirm('Apakah Anda Yakin Menghapus Data?');"
                                                class="btn btn-danger btn-sm">Delete</a>
                                            @endif
                                        </td>
                                ...
                                <table class="table table-bordered">
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            ...
                                            @if (Auth::user()->level == 'Developer')
                                            <a class="btn btn-primary btn-sm"
                                                href="daftar-light-edit/{{$lights->id}}">Edit</a>
                                            <a href="deleteLightList/{{$lights->id}}"
                                                onclick="return confirm('Apakah Anda Yakin Menghapus Data?');"
                                                class="btn btn-danger btn-sm">Delete</a>
                                            @endif
                                        </td>
                            ...
                            <div class="card-body">
                                ...
                                <table class="table table-bordered">
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a class="btn btn-info btn-sm"
                                                href="showLightDimmerList/{{$lightdimmers->id}}">API</a>
                                            @if (Auth::user()->level == 'Developer')
                                            <a class="btn btn-primary btn-sm"
                                                href="daftar-lightDimmer-edit/{{$lightdimmers->id}}">Edit</a>
                                            <a href="deleteLightDimmerList/{{$lightdimmers->id}}"
                                                onclick="return confirm('Apakah Anda Yakin Menghapus Data?');"
                                                class="btn btn-danger btn-sm">Delete</a>
                                            @endif
                                        </td>
                                ...
                                <table class="table table-bordered">
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            ...
                                            <a class="btn btn-primary btn-sm" href="#">Edit</a>
                                            <a href="#" onclick="return confirm('Apakah Anda Yakin Menghapus Data?');"
                                                class="btn btn-danger btn-sm">Delete</a>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            ...
                                            <a class="btn btn-primary btn-sm"
                                                href="daftar-Camera-edit/{{$cameras->id}}">Edit</a>
                                            <a href="deleteCameraList/{{$cameras->id}}"
                                                onclick="return confirm('Apakah Anda Yakin Menghapus Data?');"
                                                class="btn btn-danger btn-sm">Delete</a>
                            ...
                            <div class="card-body">
                                ...
                                <table class="table table-bordered">
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a class="btn btn-info btn-sm"
                                                href="showFireAlarmList/{{$firealarms->id}}">API</a>
                                            @if (Auth::user()->level == 'Developer')
                                            <a class="btn btn-primary btn-sm"
                                                href="daftar-FireAlarm-edit/{{$firealarms->id}}">Edit</a>
                                            <a href="deleteFireAlarmList/{{$firealarms->id}}"
                                                onclick="return confirm('Apakah Anda Yakin Menghapus Data?');"
                                                class="btn btn-danger btn-sm">Delete</a>
                                            @endif
                                        </td>
                                ...
                                <table class="table table-bordered">
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            ...
                                            <label class="switch">
                                                <input type="checkbox" class="custom-control-input" id="customSwitch2"
                                                    checked>
                                                <a href="{{ url('daftar-Dhtx-status/'.$dhtxs->id) }}"
                                        ...
                                        <td class="text-center">
                                            ...
                                            @if (Auth::user()->level == 'Developer')
                                            <a class="btn btn-primary btn-sm"
                                                href="daftar-Dhtx-edit/{{$dhtxs->id}}">Edit</a>
                                            <a href="deleteDhtxList/{{$dhtxs->id}}"
                                                onclick="return confirm('Apakah Anda Yakin Menghapus Data?');"
                                                class="btn btn-danger btn-sm">Delete</a>
                                            @endif
                                        </td>
