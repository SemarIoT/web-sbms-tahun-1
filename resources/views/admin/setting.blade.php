                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="row d-flex justify-content-center pt-3">
                                    ...
                                    <div class="row align-items-end">
                                        <div class="col-lg-12">
                                            <form action="{{ route('pinpointmapupdate') }}" method="POST"
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="row d-flex justify-content-center pt-3">
                                    ...
                                    <div class="row align-items-end">
                                        <div class="col-lg-12">
                                            <p class="text-xl fw-light mb-0 text-dash-color-3">@php echo
                                                number_format($energys->id );@endphp Data</p><span>
                                                <a class="btn btn-success " href="setting_energyexportxlxs">Download
                                                    Data (xlxs)</a>
                                                <a class="btn btn-info " href="setting_energyexportcsv">Download Data
                                                    (csv)</a>
                                                @if (Auth::user()->level == 'Developer')
                                                <a class="btn btn-danger " href="truncateDataEnergy"
                                                    onclick="return confirm('Data yang sudah dihapuskan tidak bisa dikembalikan lagi. Pastikan anda sudah mendownload data. Apakah anda yakin akan menghapus data?');">Delete
                                                    All Data</a>
                                                @endif
                                        </div>
                                    </div>
                                ...
                                <div class="row d-flex justify-content-center pt-3">
                                    ...
                                    <div class="row align-items-end">
                                        <div class="col-lg-12">
                                            <p class="text-xl fw-light mb-0 text-dash-color-3">@php echo
                                                number_format($energys->id );@endphp Data</p><span>
                                                <a class="btn btn-success " href="setting_dhtexportxlxs">Download Data
                                                    (xlxs)</a>
                                                <a class="btn btn-info " href="setting_dhtexportcsv">Download Data
                                                    (csv)</a>
                                                @if (Auth::user()->level == 'Developer')
                                                <a class="btn btn-danger " href="truncateDataDht"
                                                    onclick="return confirm('Data yang sudah dihapuskan tidak bisa dikembalikan lagi. Pastikan anda sudah mendownload data. Apakah anda yakin akan menghapus data?');">Delete
                                                    All Data</a>
                                                @endif
                                        </div>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    ...
                                                    <label class="switch">
                                                        ...
                                                        <a href="{{ url('ubahstatusdashboard/'.$dashboards->id) }}"
                                                            class="slider round"></a>
                                                    </label>
                                                    @else
                                                    <label class="switch">
                                                        <input type="checkbox" class="custom-control-input"
                                                            id="customSwitch2" disabled>
                                                        <a href="{{ url('ubahstatusdashboard/'.$dashboards->id) }}"
                                                            class="slider round"></a>
                                                    </label>
                                                    @endif
