                        ...
                        <div class="card mb-0">
                            <div class="card-body">
                                <div class="d-flex align-items-end justify-content-between mb-2">
                                    ...
                                    <p class="text-xxl lh-1 mb-0 text-dash-color-1">{{$energy_currents->active_power}}
                                    </p>
                                    @endforeach
                                </div>
                        ...
                        <div class="card mb-0">
                            <div class="card-body">
                                <div class="d-flex align-items-end justify-content-between mb-2">
                                    ...
                                    <p class="text-xxl lh-1 mb-0 text-success">@php echo number_format($energy_costs);
                                        @endphp</p>
                            ...
                            <div class="card-body">
                                <div class="d-flex align-items-end justify-content-between mb-2">
                                    <div class="me-2">
                                        ...
                                        <p class="text-sm text-uppercase text-gray-600 lh-1 mb-0">Current Temperature
                                        </p>
                                    </div>
                            ...
                            <div class="card-body">
                                <div class="row d-flex justify-content-center pt-3">
                                    ...
                                    <div class="row align-items-end">
                                        ...
                                        <div class="col-lg-6">
                                            <p class="text-xl fw-light mb-0 text-info">{{$energy_panels->nama}}</p>
                                            <span>
                                        </div>
                                        ...
                                        <div class="col-lg-6">
                                            <p class="text-xl fw-light mb-0 text-info">{{$energy_outlets->nama}}</p>
                                            <span>
                                        </div>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="row align-items-center mb-0">
                                    ...
                                    <div class="col-lg-6">
                                        <p class="text-xl fw-light mb-0 text-dash-color-1">{{ $energies2->tegangan }}
                                        </p>
                                        @foreach ($energy_panel as $energy_panels)
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="row align-items-center mb-0">
                                    @forelse ($energy as $energies)
                                    <div class="col-lg-6">
                                        <p class="text-xl fw-light mb-0 text-dash-color-2">{{ $energies->active_power }}
                                        </p>
                                        <p>Master</p>
                                    </div>
                                    @empty
                                    ...
                                    @forelse ($energy2 as $energies2)
                                    <div class="col-lg-6">
                                        <p class="text-xl fw-light mb-0 text-dash-color-2">{{ $energies2->active_power
                                            }}</p>
                                        @foreach ($energy_panel as $energy_panels)
                                        <p>{{$energy_panels->nama}}</p>
                                        @endforeach
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="row align-items-end">
                                    @forelse ($energy as $energies)
                                    <div class="col-lg-6">
                                        <p class="text-xl fw-light mb-0 text-warning">{{ $energies->apparent_power }}
                                        </p>
                                        <p>Master</p>
                                    </div>
                                    @empty
                                    ...
                                    @forelse ($energy2 as $energies2)
                                    <div class="col-lg-6">
                                        <p class="text-xl fw-light mb-0 text-warning">{{ $energies2->apparent_power }}
                                        </p>
                                        @foreach ($energy_panel as $energy_panels)
                                        <p>{{$energy_panels->nama}}</p>
                                        @endforeach
