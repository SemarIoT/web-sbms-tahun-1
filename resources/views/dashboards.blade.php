        ...
        <nav class="navbar navbar-expand-lg py-3 bg-dash-dark-2 border-bottom border-dash-dark-1 z-index-10">
            <div class="container-fluid d-flex align-items-center justify-content-between py-1">
                <div class="navbar-header d-flex align-items-center"><a class="navbar-brand text-uppercase text-reset">
                        <div class="brand-text brand-big"><small class="text-primary"
                                style="font-size:15px;">Smart</small><small class="text-secondary"
                                style="font-size:15px;"> Building Management System</small></div>
                        <div class="brand-text brand-sm"><strong class="text-primary">S</strong><strong>BMS</strong>
                        </div>
                    </a>

                </div>
                <div class="mx-auto"><strong class="text-success">Smart Room - Internet of Things Laboratory</strong>
                </div>
                                    ...
                                    <div class="card-body">
                                        <div class="d-flex align-items-end justify-content-between mb-2">
                                            <div class="me-2">
                                                ...
                                                <p class="text-sm text-uppercase text-gray-600 lh-1 mb-0">Energy Current
                                                </p>
                                            </div>
                                            @foreach ($energy_current as $energy_currents)
                                            <p class="text-xxl lh-1 mb-0 text-dash-color-1">
                                                {{$energy_currents->active_power}}</p>
                                            @endforeach
                                        </div>
                                    ...
                                    <div class="card-body">
                                        <div class="d-flex align-items-end justify-content-between mb-2">
                                            <div class="me-2">
                                                ...
                                                <p class="text-sm text-uppercase text-gray-600 lh-1 mb-0">Electricity
                                                    Price</p>
                                            </div>
                                            @foreach ($energy_cost_pokok as $energy_costs)
                                            <p class="text-xxl lh-1 mb-0 text-success">@php echo
                                                number_format($energy_costs); @endphp</p>
                                    ...
                                    <div class="card-body">
                                        <div class="d-flex align-items-end justify-content-between mb-2">
                                            <div class="me-2">
                                                ...
                                                <p class="text-sm text-uppercase text-gray-600 lh-1 mb-0">Current
                                                    Temperature</p>
                                            </div>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="row align-items-center">
                                            <a img href="{{url('camera')}}">
                                                <img src="img/stock/stock_cam.jpeg" alt="cam" width="100%"
                                                    height="90px">
                                            </a>
                                        </div>
                                    </div>
                                    ...
                                    <div class="card-body">
                                        <div class="row d-flex justify-content-center pt-3">
                                            ...
                                            <div class="row align-items-end">
                                                ...
                                                <div class="col-lg-6">
                                                    <p class="text-xl fw-light mb-0 text-end text-success">Online</p>
                                                    <span>
                                                </div>
                                                @else
                                                <div class="col-lg-6">
                                                    <p class="text-xl fw-light mb-0 text-end text-dash-color-3">Offline
                                                    </p><span>
                                                </div>
                                                @endif
                                                @endforeach
                                                ...
                                                <div class="col-lg-6">
                                                    <p class="text-xl fw-light mb-0 text-info">{{$energy_panels->nama}}
                                                    </p><span>
                                                </div>
                                                ...
                                                <div class="col-lg-6">
                                                    <p class="text-xl fw-light mb-0 text-info">{{$energy_outlets->nama}}
                                                    </p><span>
                                                </div>
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="row align-items-end">
                                            @forelse ($energy as $energies)
                                            <div class="col-lg-6">
                                                <p class="text-xl fw-light mb-0 text-warning">{{ $energies->frekuensi }}
                                                </p>
                                                <p>Master</p>
                                            </div>
                                            @empty
                                            ...
                                            @forelse ($energy2 as $energies2)
                                            <div class="col-lg-6">
                                                <p class="text-xl fw-light mb-0 text-warning">{{ $energies2->frekuensi
                                                    }}</p>
                                                @foreach ($energy_panel as $energy_panels)
                                                <p>{{$energy_panels->nama}}</p>
                                                @endforeach
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="row align-items-center mb-0">
                                            @forelse ($energy as $energies)
                                            <div class="col-lg-6">
                                                <p class="text-xl fw-light mb-0 text-dash-color-2">{{
                                                    $energies->active_power }}</p>
                                                <p>Master</p>
                                            </div>
                                            @empty
                                            @endforelse
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="row align-items-end">
                                            @forelse ($energy as $energies)
                                            <div class="col-lg-6">
                                                <p class="text-xl fw-light mb-0 text-info">{{ $energies->reactive_power
                                                    }}</p>
                                                <p>Master</p>
                                            </div>
                                            @empty
                                            ...
                                            @forelse ($energy2 as $energies2)
                                            <div class="col-lg-6">
                                                <p class="text-xl fw-light mb-0 text-info">{{ $energies2->reactive_power
                                                    }}</p>
                                                @foreach ($energy_panel as $energy_panels)
                                                <p>{{$energy_panels->nama}}</p>
                                                @endforeach
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="d-flex align-items-end justify-content-between">
                                            ...
                                            @else
                                            <div class="col-lg-6">
                                                <p class="text-xl fw-light mb-0 text-end text-dash-color-3">Off</p>
                                                <span>
                                            </div>
                                            @endif
                                        </div>
