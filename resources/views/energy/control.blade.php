                                    ...
                                    <div class="d-flex align-items-end justify-content-between mb-2">
                                        ...
                                        <label class="switch">
                                            <input type="checkbox" class="custom-control-input" id="customSwitch2"
                                                checked>
                                            <a href="{{ url('control-change-status-panel-master/'.$energy_panel_masters->id) }}"
                                ...
                                <div class="card mb-0">
                                    <div class="card-body">
                                        <div class="d-flex align-items-end justify-content-between mb-2">
                                            ...
                                            <div class="me-2">
                                                <p class="text-lg text-uppercase text-success lh-1 mb-0">Outlet Master
                                                </p>
                                            </div>
                                            ...
                                            <label class="switch">
                                                <input type="checkbox" class="custom-control-input" id="customSwitch2"
                                                    checked>
                                                <a href="{{ url('control-change-status-outlet-master/'.$energy_outlet_masters->id) }}"
                                                    class="slider round"></a>
                                            </label>
                                            @else
                                            <label class="switch">
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="d-flex align-items-end justify-content-between pt-2 pb-2">
                                    ...
                                    <div class="me-2">
                                        <h3 class="text-sm d-block text-dash-color-2 text-uppercase">
                                            {{$energy_panels->nama}}</h3>
                                    </div>
                                    @if($energy_panels->status==1)
                                    <label class="switch">
                                        <input type="checkbox" class="custom-control-input" id="customSwitch2" checked>
                                        <a href="{{ url('control-change-status-panel/'.$energy_panels->id) }}"
                                            class="slider round"></a>
                                    </label>
                                    @else
                                    <label class="switch">
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="d-flex align-items-end justify-content-between pt-2 pb-2">
                                    <div class="me-2">
                                        <h3 class="text-sm d-block text-dash-color-2 text-uppercase">
                                            {{$energy_outlets->nama}}</h3>
                                    </div>
                                    @if($energy_outlets->status==1)
                                    <label class="switch">
                                        <input type="checkbox" class="custom-control-input" id="customSwitch2" checked>
                                        <a href="{{ url('control-change-status-outlet/'.$energy_outlets->id) }}"
                                            class="slider round"></a>
                                    </label>
                                    @else
                                    <label class="switch">
