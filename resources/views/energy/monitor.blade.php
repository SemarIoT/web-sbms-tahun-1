                            ...
                            <div class="card-body">
                                ...
                                <div class="progress" style="height: 3px">
                                    <div class="progress-bar" role="progressbar"
                                        style="width: 30%; background-color: #28a745;" aria-valuenow="30"
                        ...
                        <div class="card mb-0">
                            <div class="card-body">
                                <div class="d-flex align-items-end justify-content-between mb-2">
                                    ...
                                    <p class="text-xxl lh-1 mb-0 text-success">Rp. @php echo
                                        number_format($energy_costs); @endphp</p>

                                    @endforeach
                                </div>
                                <div class="progress" style="height: 3px">
                                    <div class="progress-bar" style="width: 75%; background-color: #28a745;"
