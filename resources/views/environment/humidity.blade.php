                            ...
                            <div class="card-body">
                                <div class="row d-flex justify-content-center pt-3">
                                    ...
                                    <div class="row align-items-end">
                                        <div class="col-lg-5">
                                            <p class="text-xl fw-light mb-0 text-dash-color-3">{{ $item->humidity }}</p>
                                            <span>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="row d-flex justify-content-center pt-3">
                                    ...
                                    <div class="row align-items-end">
                                        <div class="col-lg-5">
                                            <p class="text-xl fw-light mb-0 text-dash-color-3">{{ $tempx1s->humidity }}
                                            </p><span>
                                        </div>
                                    </div>
                                    @empty
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="row d-flex justify-content-center pt-3">
                                    ...
                                    <div class="row align-items-end">
                                        <div class="col-lg-5">
                                            <p class="text-xl fw-light mb-0 text-dash-color-3">{{ $tempx2s->humidity }}
                                            </p><span>
                                        </div>
                                    </div>
                                    @empty
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="row d-flex justify-content-center pt-3">
                                    ...
                                    <div class="row align-items-end">
                                        <div class="col-lg-5">
                                            <p class="text-xl fw-light mb-0 text-dash-color-3">{{ $tempx3s->humidity }}
                                            </p><span>
                                        </div>
                                    </div>
                                    @empty
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="row d-flex justify-content-center pt-3">
                                    ...
                                    <div class="row align-items-end">
                                        <div class="col-lg-5">
                                            <p class="text-xl fw-light mb-0 text-dash-color-3">{{ $tempx4s->humidity }}
                                            </p><span>
                                        </div>
                                    </div>
                                    @empty
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="row d-flex justify-content-center pt-3">
                                    ...
                                    <div class="row align-items-end">
                                        <div class="col-lg-5">
                                            <p class="text-xl fw-light mb-0 text-dash-color-3">{{ $tempx5s->humidity }}
                                            </p><span>
                                        </div>
                                    </div>
                                    @empty
