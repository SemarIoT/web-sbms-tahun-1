                            ...
                            <div class="card-body">
                                <div class="d-flex align-items-end justify-content-between mb-2">
                                    ...
                                    <label class="switch">
                                        ...
                                        <a href="{{ url('change-light-master-status/'.$item->id) }}"
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="d-flex align-items-end justify-content-between pt-2 pb-2">
                                    ...
                                    <div class="me-2">
                                        <h3 class="text-sm d-block text-dash-color-2 text-uppercase">{{$nilai->nama}}
                                        </h3>
                                    </div>
                                    ...
                                    <div>
                                        <label class="switch">
                                            <input type="checkbox" class="custom-control-input" id="customSwitch2"
                                                checked>
                                            <a href="{{ url('change-light-dimmer-status/'.$nilai->id) }}"
                                                class="slider round"></a>
                                        </label>
                                    </div>
                                    <div class="row">
                                        <div class="slidecontainer">
                                            <form method="POST"
                                                action="{{ url('/change-light-dimmer-value/'.$nilai->id) }}"
                                                enctype="multipart/form-data" oninput="return onsubmitForm(this);"
                                                onchange="return onsubmitForm(this));">
                                                {{ csrf_field() }}
                                                <input type="range" name="nilai" min="25" max="90"
                                                    value={{$nilai->nilai}} class="slide" id="myRangbe">
                                                <span id="demob"></span>
                                            </form>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="slidecontainer">
                                            <input type="range" name="nilai" min="0" max="100" value="0"
                                                class="slidemati">
                                        </div>
                                    </div>
                                    @endif
                    ...
                    <div class="col-lg">
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="d-flex align-items-end justify-content-between pt-2 pb-2">
                                    <div class="me-2">
                                        <h3 class="text-sm d-block text-dash-color-2 text-uppercase">{{$control->nama}}
                                        </h3>
                                    </div>
                                    @if($control->status==1)
                                    <label class="switch">
                                        <input type="checkbox" class="custom-control-input" id="customSwitch2" checked>
                                        <a href="{{ url('change-light-status/'.$control->id) }}"
                                            class="slider round"></a>
                                    </label>
                                    @else
                                    <label class="switch">
