                            ...
                            <div class="card-body">
                                <div class="row d-flex justify-content-center pt-3">
                                    ...
                                    <div class="row align-items-end">
                                        <div class="col-lg-5">
                                            <p class="text-xl fw-light mb-0 text-dash-color-3">{{ $item->temperature }}
                                            </p><span>
                                        </div>
                                    </div>
                                    @empty
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="row d-flex justify-content-center pt-3">
                                    ...
                                    <div class="row align-items-end">
                                        <div class="col-lg-5">
                                            <p class="text-xl fw-light mb-0 text-dash-color-3">{{ $tempx1s->temperature
                                                }}</p><span>
                                        </div>
                                    </div>
                                    @empty
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="row d-flex justify-content-center pt-3">
                                    ...
                                    <div class="row align-items-end">
                                        <div class="col-lg-5">
                                            <p class="text-xl fw-light mb-0 text-dash-color-3">{{ $tempx2s->temperature
                                                }}</p><span>
                                        </div>
                                    </div>
                                    @empty
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="row d-flex justify-content-center pt-3">
                                    ...
                                    <div class="row align-items-end">
                                        <div class="col-lg-5">
                                            <p class="text-xl fw-light mb-0 text-dash-color-3">{{ $tempx3s->temperature
                                                }}</p><span>
                                        </div>
                                    </div>
                                    @empty
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="row d-flex justify-content-center pt-3">
                                    ...
                                    <div class="row align-items-end">
                                        <div class="col-lg-5">
                                            <p class="text-xl fw-light mb-0 text-dash-color-3">{{ $tempx4s->temperature
                                                }}</p><span>
                                        </div>
                                    </div>
                                    @empty
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="row d-flex justify-content-center pt-3">
                                    ...
                                    <div class="row align-items-end">
                                        <div class="col-lg-5">
                                            <p class="text-xl fw-light mb-0 text-dash-color-3">{{ $tempx5s->temperature
                                                }}</p><span>
                                        </div>
                                    </div>
                                    @empty
