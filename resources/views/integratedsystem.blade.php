            ...
            <div class="container-fluid">
                <div class="row d-flex align-items-stretch gy-4">
                    <div class="col-lg">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <h2 class="h4 mb-2 text-primary"><a
                                        href="{{$integrated_systems->link}}">{{$integrated_systems->nama}}</a></h2>
                                ...
                                <a class="btn btn-primary btn-sm"
                                    href="daftar-integratedsystem-edit/{{$integrated_systems->id}}">Edit</a>
                                <a href="deleteintegratedsystemList/{{$integrated_systems->id}}"
