    ...
    <nav class="navbar navbar-expand-lg py-3 bg-dash-dark-2 border-bottom border-dash-dark-1 z-index-10">
      <div class="container-fluid d-flex align-items-center justify-content-between py-1">
        <div class="navbar-header d-flex align-items-center"><a class="navbar-brand text-uppercase text-reset"
            href="{{url('dashboard')}}">
            <div class="brand-text brand-big"><small class="text-primary" style="font-size:15px;">Smart</small><small
                class="text-secondary" style="font-size:15px;"> Building Management System</small></div>
            <div class="brand-text brand-sm"><strong class="text-primary">S</strong><strong>BMS</strong></div>
          </a>
  ...
  <ul class="list-unstyled">
    ...
    <footer class="position-absolute bottom-0 text-end py-3 text-xs" id="footer">
      <div class="container-fluid text-center">
        <p class="mb-0 text-dash-gray">2022 &copy; Created by <a
            href="https://elektro.ft.uns.ac.id/laboratorium-internet-of-things-iot/">IoT Lab UNS</a></p>
      </div>
    </footer>
    </nav>


    {{-- <button class="btn btn-warning btn-sm d-none d-md-inline-block" type="button" data-bs-toggle="collapse"
      data-bs-target="#style-switch" id="style-switch-button"><i class="fas fa-cog fa-2x"></i></button>
