                ...
                <div class="row d-flex align-items-stretch gy-4">
                    <div class="col-lg">
                        ...
                        <div class="card">
                            <div class="card-body justify-content-center">
                                ...
                                <div id="containment-wrapper" style="width: 800px;
                                    ...
                                    <div id="draggable" class="ui-widget-content draggable"
                                        style="position: absolute; left: {{$lights->xpos}}; top: {{$lights->ypos}};">
                                        <a href="{{url('light')}}">
                                    ...
                                    <div id="draggable" class="ui-widget-content draggable"
                                        style="position: absolute; left: {{$lightdimmers->xpos}}; top: {{$lightdimmers->ypos}};">
                                        <a href="{{url('light')}}">
                                    ...
                                    <div id="draggable" class=" ui-widget-content draggable"
                                        style="position: absolute; left: {{$energypanelmasters->xpos}}; top: {{$energypanelmasters->ypos}};">
                                        <a href="{{url('monitor')}}">
                                            <img class="img-fluid" src="{{asset('img/icon/panel.png')}}" alt="...">
                                            <span
                                                class="d-flex justify-content-center">{{$energypanelmasters->nama}}</span></a>
                                    </div>
                                    @endforeach
                                    @foreach ($firealarm as $firealarms)
                                    <div id="draggable" class=" ui-widget-content draggable"
                                        style="position: absolute; left: {{$firealarms->xpos}}; top: {{$firealarms->ypos}};">
                                    ...
                                    <div id="draggable" class=" ui-widget-content draggable"
                                        style="position: absolute; left: {{$cameras->xpos}}; top: {{$cameras->ypos}};">
                                        <a href="{{url('camera')}}">
                                    ...
                                    @foreach ($dht as $dhts)
                                    <div id="draggable" class=" ui-widget-content draggable"
                                        style="position: absolute; left: {{$dhts->xpos}}; top: {{$dhts->ypos}};">
                            ...
                            <div class="d-flex justify-content-center">Reference Coordinate (<span id="results"></span>)
                            </div>
                                    ...
                                    <div class="row gy-3">
                                        <div class="col-lg-6">
                                            <div class="form-group mb-3">
                                                <label for="name-edit" class="col-dm-6 control-label">X
                                                    Coordinate</label>
                                                <div class="col-center">
                                                    <input type="text" id="x-edit" name="x-edit"
                                                        value="{{$lights->xpos}}" placeholder="200px"
                                                        class="form-control">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-lg-6">
                                            <div class="form-group mb-3">
                                                <label for="name-edit" class="col-dm-6 control-label">Y
                                                    Coordinate</label>
                                                <div class="col-center">
                                                    <input type="text" id="y-edit" name="y-edit"
                                                        value="{{$lights->ypos}}" placeholder="200px"
                                                        class="form-control">
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <form class="form-horizontal" id="formEditUser" name="formEditUser" method="POST"
                                    ...
                                    <div class="row gy-3">
                                        <div class="col-lg-6">
                                            <div class="form-group mb-3">
                                                ...
                                                <div class="col-center">
                                                    <input type="text" id="x-edit" name="x-edit"
                                                        value="{{$lightdimmers->xpos}}" placeholder="200px"
                                                        class="form-control">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-lg-6">
                                            <div class="form-group mb-3">
                                                ...
                                                <div class="col-center">
                                                    <input type="text" id="y-edit" name="y-edit"
                                                        value="{{$lightdimmers->ypos}}" placeholder="200px"
                                                        class="form-control">
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="form-group mb-3">
                                        <div class="col text-right">
                                            ...
                                            <a href="deletepinpoint/{{$lightdimmers->id}}"
                                ...
                                <form class="form-horizontal" id="formEditUser" name="formEditUser" method="POST"
                                    ...
                                    <div class="row gy-3">
                                        <div class="col-lg-6">
                                            <div class="form-group mb-3">
                                                ...
                                                <div class="col-center">
                                                    <input type="text" id="x-edit" name="x-edit"
                                                        value="{{$energypanelmasters->xpos}}" placeholder="200px"
                                                        class="form-control">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-lg-6">
                                            <div class="form-group mb-3">
                                                ...
                                                <div class="col-center">
                                                    <input type="text" id="y-edit" name="y-edit"
                                                        value="{{$energypanelmasters->ypos}}" placeholder="200px"
                                                        class="form-control">
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="form-group mb-3">
                                        <div class="col text-right">
                                            ...
                                            <a href="deletepinpoint/{{$energypanelmasters->id}}"
                                                class="btn btn-danger">Delete</a>
                                        </div>
                                    </div>
                                </form>
                                ...
                                <form class="form-horizontal" id="formEditUser" name="formEditUser" method="POST"
                                    ...
                                    <div class="row gy-3">
                                        <div class="col-lg-6">
                                            <div class="form-group mb-3">
                                                ...
                                                <div class="col-center">
                                                    <input type="text" id="x-edit" name="x-edit"
                                                        value="{{$firealarms->xpos}}" placeholder="200px"
                                                        class="form-control">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-lg-6">
                                            <div class="form-group mb-3">
                                                ...
                                                <div class="col-center">
                                                    <input type="text" id="y-edit" name="y-edit"
                                                        value="{{$firealarms->ypos}}" placeholder="200px"
                                                        class="form-control">
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="form-group mb-3">
                                        <div class="col text-right">
                                            ...
                                            <a href="deletepinpoint/{{$firealarms->id}}"
                                                class="btn btn-danger">Delete</a>
                                        </div>
                                    </div>
                                </form>
                                    ...
                                    <div class="row gy-3">
                                        <div class="col-lg-6">
                                            <div class="form-group mb-3">
                                                ...
                                                <div class="col-center">
                                                    <input type="text" id="x-edit" name="x-edit"
                                                        value="{{$cameras->xpos}}" placeholder="200px"
                                                        class="form-control">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-lg-6">
                                            <div class="form-group mb-3">
                                                ...
                                                <div class="col-center">
                                                    <input type="text" id="y-edit" name="y-edit"
                                                        value="{{$cameras->ypos}}" placeholder="200px"
                                                        class="form-control">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-group mb-3">
                                                <label for="name-edit" class="col-dm-6 control-label">X
                                                    Coordinate</label>
                                                <div class="col-center">
                                                    <input type="text" id="x-edit" name="x-edit" value="{{$dhts->xpos}}"
                                                        placeholder="200px" class="form-control">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-lg-6">
                                            <div class="form-group mb-3">
                                                <label for="name-edit" class="col-dm-6 control-label">Y
                                                    Coordinate</label>
                                                <div class="col-center">
                                                    <input type="text" id="y-edit" name="y-edit" value="{{$dhts->ypos}}"
                                                        placeholder="200px" class="form-control">
                                                </div>
                                            </div>
                                        </div>
