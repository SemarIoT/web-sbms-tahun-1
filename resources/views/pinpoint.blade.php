                        ...
                        <div class="card">
                            <div class="card-body d-flex justify-content-center">
                                <div id="containment-wrapper" class="d-flex justify-content-center">
                                    ...
                                    <div id={{$lightdimmers->nama}} class="draggable ui-widget-content" style="cursor:
                                        move;">
                                        <a href="{{url('light')}}">
                                    ...
                                    <div id={{$energypanelmasters->nama}} class="draggable ui-widget-content"
                                        style="cursor: move;">
                                        <a href="{{url('monitor')}}">
                                    ...
                                    <div id={{$firealarms->nama}} class="draggable ui-widget-content" style="cursor:
                                        move;">
                                    ...
                                    <div id={{$cameras->nama}} class="draggable ui-widget-content" style="cursor:
                                        move;">
                                        <a href="{{url('camera')}}">
