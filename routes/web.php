...
Route::get('/daftar-integratedsystem-create', function () {
    return view('admin.sensor.integratedsystemcreate');
});
...
Route::get('/createpinpoint', function () {
    return view('pinpointcreate');
});
...
Route::get('/daftar-light-create', function () {
    return view('admin.sensor.lightcreate');
});
...
Route::get('/daftar-lightDimmer-create', function () {
    return view('admin.sensor.lightdimmercreate');
});
...
Route::get('/daftar-FireAlarm-create', function () {
    return view('admin.sensor.firealarmcreate');
});
...
Route::get('/daftar-Camera-create', function () {
    return view('admin.sensor.cameracreate');
});
...
Route::get('/daftar-Outlet-create', function () {
    return view('admin.sensor.Outletcreate');
});
...
Route::get('/daftar-Dhtx-create', function () {
    return view('admin.sensor.dhtextracreate');
});
...
Route::get('/reject_doorlockAccess/{id}', [DoorlockAccessController::class, 'reject_doorlockAccess'])->name('reject_doorlockAccess');
Route::get('/create_doorlockAccess', function () {
    return view('admin.doorlockaccesscreate');
});
Route::get('/createmandiri_doorlockAccess', function () {
    return view('security.doorlockaccesscreatemandiri');
});
...
Route::get('/create_doorlockRoom', function () {
    return view('admin.doorlockaccessroomcreate');
});
